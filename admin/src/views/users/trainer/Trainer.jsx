...
const Trainer = () => {
  ...
  //     searchField,
  //   };
  //   dispatch(getAllTrainer(obj));
  //   dispatch(getTrainerStats());
  //   dispatch(getTrainerSummary());
  //   dispatch(getRecentTrainer());
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {/* Dashboard Stats */}
      <TrainerDashboard stats={managerStats} />
      ...
      <Modal
        ...
        contentLabel="Add Trainer"
        shouldCloseOnOverlayClick={true}
        shouldCloseOnEsc={true}
      >
        <AddTrainer setIsOpen={setIsAdd} />
      </Modal>
      ...
      <Modal
        ...
        style={customModalStyles}
        contentLabel="View Trainer"
        shouldCloseOnOverlayClick={true}
        shouldCloseOnEsc={true}
      >
        <ViewTrainer setIsView={setIsView} selectedUser={selectedUser} />
      </Modal>
      ...
      <Modal
        ...
        style={customModalStyles}
        contentLabel="Edit Trainer"
        shouldCloseOnOverlayClick={true}
        shouldCloseOnEsc={true}
      >
        <EditTrainer setIsEdit={setIsEdit} selectedUser={selectedUser} />
      </Modal>
      ...
      <Modal
        ...
        style={customModalStyles}
        contentLabel="Delete Trainer"
        shouldCloseOnOverlayClick={true}
        shouldCloseOnEsc={true}
      >
        <DeleteTrainer setIsDelete={setIsDelete} selectedUser={selectedUser} />
      </Modal>
    </div>
  );
};
